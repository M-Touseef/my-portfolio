  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
        ...
        {/* Logo - Reduced padding on mobile */}
        <motion.div 
        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <motion.a
              ...
              whileHover={{ 
                scale: 1.05, 
                boxShadow: isDark ? '0 0 8px rgba(167,139,250,0.5)' : '0 0 8px rgba(30,64,175,0.5)'
              }}
              whileTap={{ scale: 0.95 }}
          ...
          >
            {navOpen ? (
              <HiOutlineX className={`w-5 h-5 ${isDark ? 'text-gray-300' : 'text-gray-600'}`} />
            ) : (
              <HiOutlineMenu className={`w-5 h-5 ${isDark ? 'text-gray-300' : 'text-gray-600'}`} />
            )}
          </motion.button>
        </div>
      </div>

      {/* Mobile Drawer - Made more compact */}
      <AnimatePresence>
        {navOpen && (
          <motion.div
